...
Run("C:\Program Files (x86)\Battle.net\Battle.net Launcher.exe","C:\Program Files (x86)\Battle.net")

If WinWaitActive("登入暴雪Battle.net","",30) Then
	Local $Username01 = "angelohu0614@gmail.com"
	Local $Password01 = "y28552856"
